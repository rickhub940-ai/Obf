...
--
-- This Script provides an Obfuscation Step that converts Number Literals to
-- deeply nested, mathematically correct but extremely hard-to-reverse expressions.
...
local function approxEqual(a, b)
    ...
    if a ~= a or b ~= b then return false end -- NaN guard
...
function NumbersToExpressions:init(settings)
    ...
    self.ExpressionGenerators = {
        ...
        -- 15. Modular arithmetic (HARD to reverse): (a * b) % m = val
        function(val, depth)
        ...
        -- 16. Fractional reconstruction: (a - (a % b)) / b * b + (a % b) - offset
        function(val, depth)
        ...
        -- 17. Power chain: (a ^ b) ^ (1/b)  (cancels out)
        function(val, depth)
            if val <= 0 or val ~= math.floor(val) then return false end
        ...
        -- 20. Power-Modulo combo: (a ^ b) % m = val
        function(val, depth)
